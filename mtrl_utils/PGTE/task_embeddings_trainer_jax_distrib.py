...
from jax_models import PolicyTaskEncoder, TaskEncoder, TransitionDecoder, RewardDecoder, BehaviorDecoder, Model, Params, InfoDict
...
def task_encoder_update(key:Any, task_encoder: Model, reward_decoder: Model, transition_decoder: Model, trajectories: jnp.ndarray,
    ...
    def task_encoder_loss(task_encoder_params: Params) -> Tuple[jnp.ndarray, InfoDict]:
        ...
        task_latent = task_latent_mu + jax.random.normal(key, shape=task_latent_mu.shape) * jnp.exp(0.5 * task_latent_log_std)
...
def _update_te(rng:Any, task_encoder: Model, reward_decoder: Model, transition_decoder: Model, trajectories:jnp.ndarray,
    ...
    new_task_encoder, task_info = task_encoder_update(key, task_encoder, reward_decoder, transition_decoder,
